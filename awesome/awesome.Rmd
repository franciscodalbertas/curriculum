...
Biologist with a master’s and a PhD in Ecology with 10 years of experience working with applied research focusing on understanding how the spatial pattern of human-modified landscapes affects biodiversity, ecosystem services provision and the Climate. My main interests are related to landscape planning, spatial analysis, and the interface between science, policy, and impact evaluation.
...
tribble(
  ...
  "Visiting researcher supervised by Andrew Balmford", "2020-2021", "Conservation Science Group, University of Cambridge ", "Cambridge, United Kingdom"
